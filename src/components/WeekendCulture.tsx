      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-josh-gray-600 max-w-3xl mx-auto font-medium">
            Every weekend is an opportunity to create something amazing. We
            gather, ideate, code, and ship projects that matter.
          </p>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <CardContent className="pt-10 pb-8">
                <div
                  className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}
                >
                  <stat.icon className="w-10 h-10 text-white" />
                </div>
                <div className="text-4xl font-display font-bold text-josh-gray-900 mb-2">
                  {stat.value}
                </div>
                <div className="text-josh-gray-600 font-medium">
                  {stat.label}
                </div>
              </CardContent>
            </Card>
