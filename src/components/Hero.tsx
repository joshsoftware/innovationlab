  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 left-16 w-96 h-96 bg-gradient-to-tr from-josh-orange/15 to-josh-purple/15 rounded-full opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/3 left-1/3 w-4 h-4 bg-josh-teal rounded-full animate-pulse-subtle"></div>
        <div className="absolute bottom-1/4 right-1/4 w-3 h-3 bg-josh-orange rounded-full animate-pulse-subtle" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-8">
        ...
        <p className="text-xl md:text-2xl text-josh-gray-600 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
          ...
          <span className="text-josh-teal font-semibold"> Weekend warriors</span> creating 
          <span className="text-josh-orange font-semibold"> tomorrow's solutions</span> today.
        </p>
